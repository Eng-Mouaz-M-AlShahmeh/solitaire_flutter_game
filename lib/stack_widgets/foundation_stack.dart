...
class FoundationStackWidget extends StatefulWidget {
  ...
  @override
  FoundationStackWidgetState createState() => FoundationStackWidgetState();
}

class FoundationStackWidgetState extends State<FoundationStackWidget> {
  @override
